...
router.get(
  ...
  asyncHandler(async (req, res) => {
    const { timeframe = 'all-time', phase, page = 1, limit = 50 } = req.query
  ...
  asyncHandler(async (req, res) => {
    const pointsRules = [
      ...
      },
      {
        ...
        points: 10,
        description: 'Finish a course module',
      },
      {
      ...
      },
      {
        action: 'Share Win',
        points: 20,
        description: 'Share a personal victory',
      },
      {
        action: 'Complete Challenge',
        points: 25,
        description: 'Complete weekly/monthly challenges',
      },
      {
      ...
      },
      {
        ...
        points: 5,
        description: 'Commit to attending an event',
      },
      {
        action: 'Like Post',
        points: 1,
    ...
    const levelInfo = [
      ...
      },
      {
        level: 'Builder',
        range: '100-249 pts',
        description: 'Building momentum and connections',
      },
      {
        level: 'Overcomer',
        range: '250-499 pts',
        description: 'Overcoming challenges and growing',
      },
      {
        level: 'Mentor-in-Training',
        range: '500-749 pts',
        description: 'Ready to help guide others',
      },
      {
        level: 'Legacy Leader',
        range: '750+ pts',
        description: 'Leading by example and creating lasting impact',
      },
    ]
    ...
    res.status(200).json({
      ...
      data: {
        ...
        levelInfo,
        message:
          'Points are earned through active participation and growth within the community.',
      },
    })
  }),
)
